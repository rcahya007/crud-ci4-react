...
const SignIn = () => {
  ...
  const [errorCre, setErrorCre] = useState(null);
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const handleSignIn = async (data) => {
    try {
      ...
      setErrorCre(e.response.data.message);
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Sign In | CI4 React TailwindCss</title>
        </Helmet>
      </HelmetProvider>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen w-screen flex justify-center items-center">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <p className="font-bold text-4xl">Meta Media Optima</p>
              </Link>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to Admin Meta Media Optima
              </h2>
              ...
              <form onSubmit={handleSubmit(handleSignIn)}>
                ...
                <div className="mb-5">
                  ...
                  />
                  {errorCre && <p className="text-red">{errorCre}</p>}
                </div>
